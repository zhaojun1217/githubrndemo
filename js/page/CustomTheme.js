...
import {Modal, Text, TouchableHighlight, StyleSheet, View, Platform, DeviceInfo} from 'react-native';
...
class CustomTheme extends Component {
    ...
    onSelectTheme(themeKey) {
        this.props.onClose(); // 关闭dialog
        this.themeDao.save(ThemeFlags[themeKey]); // 主题保存
        const {onThemeChange} = this.props;
        onThemeChange(ThemeFactory.createTheme(ThemeFlags[themeKey])); // 发送action
    }
...
// 注意 connect真是个function 并不应是一定要放在 export之后
